...
import { EntityArrayResponseType, FamilyMemberService } from '../service/family-member.service';
...
export class FamilyMemberComponent implements OnInit {
  ...
  trackId = (_index: number, item: IFamilyMember): number => this.familyMemberService.getFamilyMemberIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.familyMembers = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IFamilyMember[] | null): IFamilyMember[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.familyMemberService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
