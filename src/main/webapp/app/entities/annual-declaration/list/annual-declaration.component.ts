...
@Component({
  ...
  templateUrl: './annual-declaration.component.html',
})
export class AnnualDeclarationComponent implements OnInit {
  annualDeclarations?: IAnnualDeclaration[];
  isLoading = false;
  ...
  delete(annualDeclaration: IAnnualDeclaration): void {
    const modalRef = this.modalService.open(AnnualDeclarationDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.annualDeclaration = annualDeclaration;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.annualDeclarations = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IAnnualDeclaration[] | null): IAnnualDeclaration[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.annualDeclarationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
